    ...
    return const Align(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          CustomTextAndTextfeild(text: 'Pincode', hintText: '450116'),
          SizedBox(height: 20),
          CustomTextAndTextfeild(
              text: 'Address', hintText: '216 St Paul\'s Rd, '),
          SizedBox(height: 20),
          CustomTextAndTextfeild(text: 'City', hintText: 'London'),
          SizedBox(height: 20),
          CustomTextAndTextfeild(text: 'State', hintText: 'N1 2LL,'),
          SizedBox(height: 20),
          CustomTextAndTextfeild(text: 'Country', hintText: 'United Kingdom'),
          SizedBox(height: 25),
          Divider(
            color: Colors.grey,
            thickness: 1.0,
